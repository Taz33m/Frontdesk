    ...
    for attempt in range(1, max_attempts + 1):
        try:
            if attempt > 1:
                ...
                print("MESSAGE", content_to_summarize)
            else:
...
def monitor_emails():
    ...
    print("🔄 Starting Enhanced Gmail Email Monitor...")
    ...
    processed_label_id = get_or_create_label(service, CONFIG['processed_label'])
    ...
    while RUNNING:
        try:
            ...
            messages = get_unprocessed_emails(service, processed_label_id, since_time=last_check - timedelta(hours=1))
