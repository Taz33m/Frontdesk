...
CONFIG = {
    ...
    'google_project_id': "pennapps-xxvi-472713",  # Google Cloud Project ID (auto-detected if None)
}
...
def create_calendar_event(calendar_id, event_data):
    ...
    try:
        ...
        print("CALENDAR ID\n", calendar_id, "CALENDAR EVENT DATA\n", event_data)
        return None

def format_event_datetime(date_str, time_str=None, timezone=load_user_info()["default_tz"]):
    ...
    try:
        if time_str:
            ...
            return {
                ...
                'timeZone': timezone if timezone != 'UTC' else load_user_info()["default_tz"]
            }
        else:
...
def monitor_emails():
    ...
    calendar_service = build('calendar', 'v3', credentials=gmail_service._http.credentials)
